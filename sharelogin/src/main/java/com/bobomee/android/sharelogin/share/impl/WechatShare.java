...
import com.bobomee.android.sharelogin.wxapi.WXAuthHandlerActivity;
...
public class WechatShare implements IShare {
  ...
  public WechatShare(Context activity) {
   context=activity;
    WxLSUtil.init(context);
  ...
  public static void setmIShareCallBack(IShareCallBack iShareCallBack){
    context=null;
    mIShareCallBack=iShareCallBack;
  }
