...
public class LoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        String responseBodyString = response.body().string().replace("\"data\":\"\"","\"data\":null")
                .replace("\"data\": \"\"","\"data\":null");
       // String responseBodyString = response.body().string().replace("\"data\": \"\",","");
        ...
        try {
            ...
            if(request.url().toString().contains("/login")&& CommonUtils.isNotEmpty(cookie)){
                 COOKIE=cookie;
                LogUtil.getInstance().e(cookie);
            }
